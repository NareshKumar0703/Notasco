...
const PostCard = ({ post, onLike }) => {
    return (
        <article className="card p-5 animate-fade-in">
            ...
            {/* Content */}
            <p className="text-sm text-[var(--color-text)] leading-relaxed mb-4">{post.content}</p>
            ...
            <div className="flex items-center gap-4 pt-3 border-t border-[var(--color-border)]">
                ...
                <button
                    ...
                    className={`flex items-center gap-1.5 text-sm transition-colors ${post.liked ? 'text-pink-400' : 'text-[var(--color-text-muted)] hover:text-pink-400'
                        }`}
                >
...
const Home = () => {
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-4">
            {/* Page title */}
            <div className="mb-6">
                <h1 className="text-2xl font-bold text-[var(--color-text)]">Home Feed</h1>
                <p className="text-sm text-[var(--color-text-muted)] mt-1">See what&apos;s happening in your network</p>
            </div>
            ...
            {loading ? (
                ...
                <div className="card p-12 text-center">
                    <p className="text-[var(--color-text-muted)]">No posts yet. Be the first to share something!</p>
                </div>
            ) : (
